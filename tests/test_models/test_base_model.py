...
class TestBaseModel(unittest.TestCase):
    ...
    def setUp(self):
        '''Set up base by creating instance of the BaseModel'''
    ...
    def test_instances(self):
        """Tests if instances are created"""
    ...
    def test_datetime(self):
        """Test created_at and update_at attributes:
    ...
    # def tearDown(self):
    #     """Disposes instances of class created"""
